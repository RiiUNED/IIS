...
public class Servicios {
	...
	public static int getAnno(Scanner sc) {
		int anno;
		do {
			System.out.print("Ingrese el año (1601..3000): ");
			anno = sc.nextInt();
	...
	private static void printMes(int init, Mes mes, int anno, LinkedList<String> dias) {
		...
		int corte = 9 - init;
		printCabeza();
		Integer marcador = printDinit(init, dias);
		System.out.println();
	...
	private static void printMes(int init, int top, Integer marcador, LinkedList<String> dias) {
		int viernes = 5;
		int domingo = 7;
		boolean cV = false;
		boolean cD = false;
