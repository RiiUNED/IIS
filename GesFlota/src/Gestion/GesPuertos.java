...
public class GesPuertos {
	public static void MenuEditarPuerto(Scanner sc, BBDD bbdd) {
	     ...
	     do {
	         ...
	         id = sc.nextInt();
	         sc.nextLine(); // consume el salto de línea después del número entero
	         System.out.print("Nombre (entre 1 y 20 caracteres)? ");
	         nombre = sc.nextLine();
	         System.out.print("Tipo (Y-Yacimiento, R-Refinería, D-Deposito)? ");
	         tipo = sc.next().charAt(0);
	         System.out.print("IMPORTANTE: Esta opción borra los datos anteriores. Son " +
